          ...
          >
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex items-center gap-1 w-96">
                <span className="text-md font-medium overflow-x-hidden text-white">
        ...
        <div className="flex w-full justify-end">
          {isDone ? (
            <div className="space-y-4 w-fit">
              <Button
                size="lg"
                className="rounded-xl font-semibold relative py-4 text-md flex gap-2 items-center w-full bg-white text-white bg-gradient-to-r from-indigo-500 to-purple-500"
                onClick={downloadAll}
              >
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className="bg-neutral-800 h-72 lg:h-80 xl:h-96 rounded-2xl shadow-sm border border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
